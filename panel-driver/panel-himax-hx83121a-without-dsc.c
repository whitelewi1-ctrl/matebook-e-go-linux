...
/* Module parameter to skip reset and init - preserve UEFI state */
...
static const struct drm_display_mode gaokun_csot_modes[] = {
	{
		/* Fix: clock must match htotal * vtotal * refresh / 1000 */
		/* htotal = 1600 + 60 + 20 + 40 = 1720 */
		/* vtotal = 2560 + 168 + 4 + 18 = 2750 */
		/* clock = 1720 * 2750 * 60 / 1000 = 283800 kHz */
		.clock = (1600 + 60 + 20 + 40) * (2560 + 168 + 4 + 18) * 60 / 1000,
		.hdisplay = 1600,
		.hsync_start = 1600 + 60,      /* hfp = 60 */
		.hsync_end = 1600 + 60 + 20,   /* hsync = 20 */
		.htotal = 1600 + 60 + 20 + 40, /* hbp = 40, htotal = 1720 */
		.vdisplay = 2560,
		.vsync_start = 2560 + 168,     /* vfp = 168 */
		.vsync_end = 2560 + 168 + 4,   /* vsync = 4 */
		.vtotal = 2560 + 168 + 4 + 18, /* vbp = 18, vtotal = 2750 */
	},
};
...
static int hx83121a_prepare(struct drm_panel *panel)
{
	...
	/* Skip reset and init to preserve UEFI backlight state */
	if (skip_init) {
